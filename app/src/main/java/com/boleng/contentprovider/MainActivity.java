...
import com.boleng.contentprovider.test.uri.UriActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        btnJumpToUri = (Button) findViewById(R.id.btn_jump_to_uri);
        ...
        btnJumpToUri.setOnClickListener(this);
